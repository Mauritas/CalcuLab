...
function checkAllValues(){
    ...
    const checkAlerta = document.querySelectorAll(".alerta");

    
    if(sodio.value !== ""){
        if(!(checkAlerta[0].classList.contains("active") && checkAlerta[1].classList.contains("active")  && checkAlerta[2].classList.contains("active") )){
     ...
     requestAnimationFrame(checkAllValues);
}
